.PHONY: fmt lint test test-integration test-contract test-architecture build verify clean migrate-up migrate-down
...
verify: fmt lint test test-integration test-contract test-architecture build
