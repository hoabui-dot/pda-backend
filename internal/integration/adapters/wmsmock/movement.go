...
func MovementTasks() []domain.Task {
	...
	return []domain.Task{
		{ID: "PUT-001", Workflow: domain.Putaway, Status: domain.New, WarehouseID: "WH-01", Version: 1, SourceLocation: "STAGE-01", DestinationLocation: "BULK-01", ItemID: "ITEM-001", Barcode: "PUT-ITEM-001", RequiredQuantity: 5, UpdatedAt: n},
